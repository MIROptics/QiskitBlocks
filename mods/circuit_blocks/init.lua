...
circuit_blocks:register_circuit_block(CircuitNodeTypes.Y, false, false, false, true)
circuit_blocks:register_circuit_block(CircuitNodeTypes.Y, true, false, false, true)
circuit_blocks:register_circuit_block(CircuitNodeTypes.Y, false, true, false, true)
circuit_blocks:register_circuit_block(CircuitNodeTypes.Z, false, false, false, true)
circuit_blocks:register_circuit_block(CircuitNodeTypes.Z, true, false, false, true)
circuit_blocks:register_circuit_block(CircuitNodeTypes.Z, false, true, false, true)
circuit_blocks:register_circuit_block(CircuitNodeTypes.S, false, false, false, false)
circuit_blocks:register_circuit_block(CircuitNodeTypes.SDG, false, false, false, false)
circuit_blocks:register_circuit_block(CircuitNodeTypes.T, false, false, false, false)
circuit_blocks:register_circuit_block(CircuitNodeTypes.TDG, false, false, false, false)
